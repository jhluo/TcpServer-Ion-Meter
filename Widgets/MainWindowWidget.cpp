...
void MainWindowWidget::createLayout()
{
    ...
    m_pLogCheckBox = new QCheckBox("Enable Data Log");
    ...
    //pSplitter->addWidget(m_pClientTableView);
...
void MainWindowWidget::populateWidgets()
{
    ...
    bool writeDatabase = settings.readMiscSettings("writeDatabase", false).toBool();
    m_pLogCheckBox->setChecked(writeDatabase);
